...
func _init():
	...
	persons.append(Build(4, "Alien 1", Enums.Race.Alien, [], load("res://src/game/people/people_alien_1.png")))
	persons.append(Build(5, "Alien 2", Enums.Race.Alien, [], load("res://src/game/people/people_alien_2.png")))
	persons.append(Build(6, "Robot 1", Enums.Race.Robot, [], load("res://src/game/people/people_robot_1.png")))
	persons.append(Build(7, "Robot 2", Enums.Race.Robot, [], load("res://src/game/people/people_robot_1.png")))
